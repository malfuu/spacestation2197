...
pub mod layers {
    ...
    pub const WORLD_TEXT_LAYER: GlobalZIndex = GlobalZIndex(-99);
    pub const WINDOWS_LAYER: GlobalZIndex = GlobalZIndex(0);
    pub const HUD_LAYER: GlobalZIndex = GlobalZIndex(1);
}
